...
if($_POST['qualification']!=NULL){ $qualification=$_POST['qualification']; }
if($_POST['experience']!=NULL){ $experience=$_POST['experience']; }
...
$subject = 'Career Enquiry- Bharat Engineering';
...
<tr bgcolor='ffffff'>
<td height='40' style='text-align:center;'> Career Enquiry- Bharat Engineering</td>
</tr>
<tr>
<td>
<table border='0' width='560' align='center' cellpadding='0' cellspacing='0' class='container-middle'>
...
<td mc:edit='subtitle1' class='main-subheader' style='color: #555; font-size: 13px; font-weight: normal; font-family: Helvetica, Arial, sans-serif;'>
<multiline>
<i>Qualification : ".$qualification."</i>
</multiline>
</td>
</tr>
...
$mail = new PHPMailer();		
$mail->From      = 'noreply@bharatengg.in';		
$mail->FromName  = "TD-G Rank-Enquiry";		
$mail->Subject   = $subject;		
$mail->Body      = $message;		
$mail->SetFrom( "noreply@bharatengg.in", 'TD-G Rank-Enquiry');


$mail->AddAddress('info@bharatengg.in', 'Bharat Engineering');
$mail->AddCC('leadtest@grank.co.in','G-rank');
        // $mail->AddAddress('prashanth@grank.co.in', 'Bharat Engineering');

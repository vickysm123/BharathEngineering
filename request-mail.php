...
if($_POST['companyname']!=NULL){ $companyname=$_POST['companyname']; }
if($_POST['city']!=NULL){ $city=$_POST['city']; }
if($_POST['phone']!=NULL){ $phone=$_POST['phone']; }
if($_POST['email']!=NULL){ $email=$_POST['email']; }
if($_POST['item']!=NULL){ $item=$_POST['item']; }
if($_POST['quantity']!=NULL){ $quantity=$_POST['quantity']; }
...
$subject = 'Requesting a Quote- Bharat Engineering';
        ...
        <tr>
            <td width='100%' align='center' valign='top'>
                ...
                <table width='600' border='0' cellpadding='0' cellspacing='0' align='center' class='container' bgcolor='ffffff'>
                    ...
                    <tr bgcolor='ffffff'>
                        <td height='40' style='text-align:center;'> Requesting a Quote- Bharat Engineering </td>
                    </tr>
                    <tr>
                        <td>
                            <table border='0' width='560' align='center' cellpadding='0' cellspacing='0' class='container-middle'>
...
$response = $_POST["g-recaptcha-response"];
	...
	curl_setopt_array($ch, [
		...
		CURLOPT_POST => true,
		CURLOPT_POSTFIELDS => [
			'secret' => '6Lfbb6MUAAAAAKw6ytoTt5cuGdQQGtjekbj410Xz',
			'response' => $_POST["g-recaptcha-response"],
	...
	if ($json->success==false) {
		...
		$mail = new PHPMailer();		
    	$mail->From      = 'enquiry@grank.co.in';		
    	$mail->FromName  = "TD-G Rank-Enquiry";		
    	$mail->Subject   = $subject;		
    	$mail->Body      = $message;		
    	$mail->SetFrom( "enquiry@grank.co.in", 'TD-G Rank-Enquiry');
      
           
   $mail->AddAddress('info@bharatengg.in', 'Bharat Engineering');
//   $mail->AddAddress('tejaswini@grank.co.in', 'Bharat Engineering');
   $mail->AddBCC('seo.grank@gmail.com','G-rank');     
   $mail->AddBCC('akshaya.grank@gmail.com','G-rank');
    $mail->AddBCC('anjali@grank.co.in','G-rank');
  $mail->AddAttachment($_FILES['filee']['tmp_name'], $_FILES['filee']['name']);
...
if($mail->send())
    {    
		...
		header('Location: https://www.bharatengg.in/thank-you.php');
    }
